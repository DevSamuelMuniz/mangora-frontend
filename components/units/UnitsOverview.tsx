...
export default function UnitsOverview() {
  ...
  async function confirmRemoveUnit() {
    ...
    try {
      ...
      setActionError(requestError instanceof Error ? requestError.message : "Não foi possível remover a loja.");
    }
  }
