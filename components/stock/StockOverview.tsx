  ...
  return (
    <section>
      ...
      <div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <SummaryCard icon={CircleDollarSign} label="Valor estimado" value={formatCurrency(overview.summary.inventoryValue)} iconClassName="bg-yellow-50 text-yellow-600" />
...
function movementTypeLabel(type: "ENTRY" | "EXIT" | "ADJUSTMENT" | "TRANSFER_IN" | "TRANSFER_OUT") { if (type === "ENTRY") return "Entrada"; if (type === "EXIT") return "Saída"; if (type === "TRANSFER_IN") return "Transferência recebida"; if (type === "TRANSFER_OUT") return "Transferência enviada"; return "Ajuste"; }
