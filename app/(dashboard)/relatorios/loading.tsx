...
export default async function ReportsLoading() {
  ...
  return (
    <div role="status" aria-label={t("pageMeta.loading.relatorios")} className="animate-pulse space-y-4">
      <div className="flex items-end justify-between gap-4"><div><div className="h-3 w-36 rounded bg-orange-100" /><div className="mt-3 h-8 w-40 rounded-lg bg-slate-200" /><div className="mt-2 h-3 w-72 max-w-full rounded bg-slate-100" /></div><div className="hidden h-11 w-80 rounded-xl bg-slate-200 sm:block" /></div>
